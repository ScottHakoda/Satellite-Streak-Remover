...
def subtract_streaks(image_data, lines, profile_half_width=35, n_samples=100, progress_callback=None, log_callback=None):
    """
    ...
    # REMOVED: The median_filter step that was causing the negative trenching/ringing
